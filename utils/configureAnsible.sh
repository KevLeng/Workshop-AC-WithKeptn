...
export DT_TENANT_ID=$(cat ../credentials/creds.json | jq -r '.dynatraceTenantID')
export DT_ENVIRONMENT_ID=$(cat ../credentials/creds.json | jq -r '.dynatraceEnvironmentID')
export DT_API_TOKEN=$(cat ../credentials/creds.json | jq -r '.dynatraceApiToken')
export DT_PAAS_TOKEN=$(cat ../credentials/creds.json | jq -r '.dynatracePaaSToken')
